...
MONITOR_INTERVAL_SECONDS = int(os.getenv('MONITOR_INTERVAL_SECONDS', 1))
OPEN_FLUSH_INTERVAL_SECONDS = int(os.getenv('OPEN_FLUSH_INTERVAL_SECONDS', 5))
MAX_BATCH_TO_FLUSH = int(os.getenv('MAX_BATCH_TO_FLUSH', 5000))
...
MAX_OPENS_ALLOWED_IN_STATE = int(os.getenv('MAX_OPENS_ALLOWED_IN_STATE', 10))
